...
package com.chintans.venturebox.helpers;
...
public class SettingsHelper {
    ...
    public static final String PROPERTY_DEVICE_SELECT = "deviceselect";
    ...
    private static final boolean DEFAULT_DEVICE_SELECT = false;
    ...
    public boolean getDeviceSelect() {
        return settings.getBoolean(PROPERTY_DEVICE_SELECT, false);
    }
