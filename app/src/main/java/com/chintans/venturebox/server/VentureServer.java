...
package com.chintans.venturebox.server;

import com.chintans.venturebox.updater.Server;
import com.chintans.venturebox.updater.UpdatePackage;
...
public class VentureServer implements Server {

    private static final String URL = "http://api.venturerom.com/updates/%s";
