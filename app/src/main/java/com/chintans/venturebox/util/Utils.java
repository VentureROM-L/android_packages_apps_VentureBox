...
import com.chintans.venturebox.updater.Updater;
...
public class Utils {
    ...
    public static final String FILES_INFO = "com.chintans.venturebox.util.Utils.FILES_INFO";
    public static final String CHECK_DOWNLOADS_FINISHED = "com.chintans.venturebox.util.Utils.CHECK_DOWNLOADS_FINISHED";
    public static final String CHECK_DOWNLOADS_ID = "com.chintans.venturebox.util.Utils.CHECK_DOWNLOADS_ID";
    public static final String MOD_VERSION = "ro.mod.version";
    public static final String RO_VENTURE_VERSION = "ro.venture.version";
    ...
    public static void showNotification(Context context, PackageInfo[] infosRom,
            PackageInfo[] infosGapps) {
